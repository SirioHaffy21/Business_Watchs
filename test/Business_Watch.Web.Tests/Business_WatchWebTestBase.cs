...
{
    public abstract class Business_WatchWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Business_WatchWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Business_WatchWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Business_WatchDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Business_WatchDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Business_WatchDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Business_WatchDbContext, Task<T>> func)
        {
            T result;
